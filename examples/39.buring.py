...
class BuringWidget(QtGui.QWidget):
	def __init__(self):
		super(BuringWidget, self).__init__()
		self.initUI()
	...
	def initUI(self):
		...
		self.connect(self,QtCore.SIGNAL('updateBurningWidget(int)'),self.setValue)
